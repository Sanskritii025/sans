...
function BulkStudentUpload({ onUploadComplete }) {
  ...
  const downloadTemplate = () => {
    ...
    const csvContent = [
      'Name,Email,Roll No,Division,Parent Email',
      ...templateData.map(row => 
        `${row.Name},${row.Email},${row['Roll No']},${row.Division},${row['Parent Email']}`
      )
    ].join('\n');
      ...
      <div className="card p-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            ...
            <li>• Required columns: Name, Email, Roll No</li>
            <li>• Optional columns: Division, Parent Email</li>
            <li>• Existing students will be updated, new ones will be created</li>
          </ul>
          <button
