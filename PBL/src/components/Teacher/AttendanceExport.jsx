...
function AttendanceExport() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const filename = `attendance-export-${today}.xlsx`;
      ...
      <div className="card p-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Excel file with two sheets: "Attendance Records" and "Attendance Summary"</li>
            <li>• Records sheet: Individual attendance entries</li>
            <li>• Summary sheet: Student-wise attendance percentages</li>
            <li>• Includes parent email information for alerts</li>
          </ul>
        </div>
